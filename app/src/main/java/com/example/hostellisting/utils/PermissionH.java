package com.example.hostellisting.utils;
...
public class PermissionH {
    ...
    private PermissionH(Activity context) {
        this.context = context;
    }

    public static PermissionH getInstance(Activity context) {
        PermissionH com = new PermissionH(context);
        return com;
    }
